...
from .file_handlers import update_status, generate_qr_for_output, get_categories, get_targets_root_dir
...
__all__ = [
    ...
    'update_status', 'generate_qr_for_output', 'get_categories', 'get_targets_root_dir',
